...
// go to the right portion of pivot eventually after swapping)
// 3)Move J / Right till you find an ele that is smaller than pivot (as it will
// go to the left portion of pivot eventually after swapping)
...
int findPivot(vector<int> &arr, int low, int high) {
	...
	while(left <= right) {
		...
		//move right pointer until you have an ele which is < than pivot
...
//Worst case would occur when pivot is the smallest / largest ele
